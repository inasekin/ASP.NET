...
using Pcf.GivingToCustomer.WebHost.EventHandlers;
using Pcf.GivingToCustomer.WebHost.Services;
using Pcf.GivingToCustomer.WebHost.GraphQL.Queries;
using Pcf.GivingToCustomer.WebHost.GraphQL.Mutations;
...
namespace Pcf.GivingToCustomer.WebHost
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Настройка RabbitMQ (временно отключена для демо)
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IDbInitializer dbInitializer)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                // gRPC сервисы
                endpoints.MapGrpcService<GrpcCustomersService>();
